...
- **Name:Saradha
- **Current Role:Senior Performance Tester
- **Years in Current Role:8 years
- **Date Submitted:3/03/2026
...
| # | Accomplishment |
|---|---------------|
| 1 | Automation - Developed an end-to-end performance engine for automated data seeding and test orchestration.
| 2 | Capacity Testing - Executed comprehensive Capacity Planning and establishing a baseline to support target user volumes without latency degradation.
| 3 | Synthetic Data generation Tool - Built a custom utility to generate high-volume, production-like datasets, slashing environment prep time.
| 4 | Real Analytics app - Cross-Functional SLA Dashboard: Built a centralized observability platform with tailored views for Eng, QA, PO, and CS, providing a unified source of truth for internal SLA compliance
| 5 | Performance Scalable Automation - Developed scalable performance test scripts in k6 by dynamically generating and injecting test data, enabling reliable parallel and high-concurrency execution
